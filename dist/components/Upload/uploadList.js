...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "sweet-upload-list" }, fileList.map(function (file) {
        return (React.createElement("li", { className: "sweet-upload-list-item", key: file.uid },
            ...
            file.status === "uploading" && (React.createElement(Progress, { percent: file.percentage || 0 }))));
    })));
};
