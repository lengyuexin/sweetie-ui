...
export var Select = function (props) {
    ...
    var containerClass = classNames("sweet-select", {
        "menu-is-open": menuOpen,
        "is-disabled": disabled,
        "is-multiple": multiple,
    });
    return (React.createElement("div", { className: containerClass, ref: containerRef },
        React.createElement("div", { className: "sweet-select-input", onClick: handleClick },
            React.createElement(Input
            // ref={input}
            , { 
                // ref={input}
                placeholder: placeholder, value: value, readOnly: true, icon: "angle-down", disabled: disabled, name: name })),
        React.createElement(SelectContext.Provider, { value: passedContext },
            React.createElement(Transition, { in: menuOpen, animation: "zoom-in-top", timeout: 300 },
                React.createElement("ul", { className: "sweet-select-dropdown" }, generateOptions()))),
        multiple && (React.createElement("div", { className: "sweet-selected-tags", style: { maxWidth: containerWidth.current - 32 } }, selectedValues.map(function (value, index) {
            return (React.createElement("span", { className: "sweet-tag", key: "tag-" + index },
                value,
